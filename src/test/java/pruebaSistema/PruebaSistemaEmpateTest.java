...
public class PruebaSistemaEmpateTest {
	...
	public void test() {
        ...
        WebElement cell_2 = driver2.findElement(By.id("cell-3"));
        cell_2.click();
        
        cell_1 = driver1.findElement(By.id("cell-1"));
        cell_1.click();
        ...
        cell_2 = driver2.findElement(By.id("cell-2"));
        cell_2.click();
        
        cell_1 = driver1.findElement(By.id("cell-7"));
        cell_1.click();
        
        cell_2 = driver2.findElement(By.id("cell-8"));
        cell_2.click();
        
        cell_1 = driver1.findElement(By.id("cell-5"));
        cell_1.click();
